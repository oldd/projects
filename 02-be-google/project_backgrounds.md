...
2. Follow the instructions atop the [Google Homepage project](/02-be-google/README.md) to set up a Github repository for this project (of course you'll need to change the title).
